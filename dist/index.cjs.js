...
var useWalletModal = function (login, logout, submit, isFulfilled, connectTitle, learnConnect, account) {
    ...
    var onPresentAccountModal = useModal(React__default['default'].createElement(AccountModal, { account: account || "", logout: logout, submit: submit, isFulfilled: isFulfilled }))[0];
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout, submit: submit, isFulfilled: isFulfilled, connectTitle: connectTitle, learnConnect: learnConnect }))),
